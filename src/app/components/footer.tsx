...
const Footer = () => {
  return (
    <div className='bg-[#2A254B] w-full font-myfont text-white'>
       <footer className="footer  text-base-content p-10 flex flex-wrap gap-48">
  ...
  <form>
    ...
    <div className="mt-6 flex items-center ">
            <input
              ...
              className="px-4 py-2  bg-[#FFFFFF26] h-[56px] text-[#2A254B] focus:outline-none  w-full sm:w-[300px]"
            />
            <button
              className="px-4 py-2 text-[#2A254B] bg-white h-[56px] hover:bg-[#af9d9d] transition duration-300"
            >
              Signup
            </button>
          </div>
